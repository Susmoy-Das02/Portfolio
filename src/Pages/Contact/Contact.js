...
const Contact = () => {
    function sendEmail (e){
        ...
        emailjs.sendForm('service_7ghc4d5' , 'template_78gc8ve' ,e.target, 'topJvVnOhTNfLQbQZ').then(res=>{
            console.log(res);
                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                <a class="text-green-500">susmoy536@gmail.com</a>
                                <p class="leading-normal my-5">Dhaka,Bangladesh
                                </p>
